...
public class CamsNpcBrain : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        looker = GetComponentInChildren<Looker_Old>();
    ...
    public void ReceiveBroadcast(CamsPlayerController.BroadcastType type, GameObject shouldSee, GameObject extraObject )
    {
        if (
            ...
            && !dead && !strangled)
        {
            ...
            switch (type)
            {
                case CamsPlayerController.BroadcastType.Drag:
                    ...
                    break;
                case CamsPlayerController.BroadcastType.Strangle:
    ...
    private void ParseCombatTarget(GameObject attacker, GameObject attacked)
    {
        ...
        if (attacked != null)
        {
            CamsNpcBrain strBrain = attacked.GetComponent<CamsNpcBrain>();
    ...
    public bool Crunch()
    {
        ...
        if(mvmntController.distanceToTarget <= crunchDistance + .3f)
        {
            ...
            // if npc
            CamsNpcBrain targetBrain = combatTarget.GetComponent<CamsNpcBrain>();
            if(targetBrain != null)
            {
